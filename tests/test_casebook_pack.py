"""Regression checks for the thread-ops-backup-map casebook."""
...
from casebook.harness import assert_expected, thread_ops_backup_map_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(thread_ops_backup_map_summary(), assert_expected())
